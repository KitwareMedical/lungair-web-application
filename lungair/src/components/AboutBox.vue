<template>
  <v-card>
    ...
    <v-card-text>
      ...
      <ul>
        <li>
          <span>LungAIR web application source code repo: </span>
          <a
            rel="noopener noreferrer"
            target="_blank"
            href="https://github.com/kitwaremedical/lungair-web-application"
          >
            https://github.com/KitwareMedical/lungair-web-application
          </a>
        </li>
        <li>
